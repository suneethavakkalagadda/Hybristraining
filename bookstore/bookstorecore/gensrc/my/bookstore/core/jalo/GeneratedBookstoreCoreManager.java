 ...
 * --- Generated at Jul 26, 2024, 6:47:16 PM                    ---
 * ----------------------------------------------------------------
 */
...
public abstract class GeneratedBookstoreCoreManager extends Extension
{
	...
	**/
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>Product.productlist</code> attribute.
	 * @return the productlist
	 */
	public String getProductlist(final SessionContext ctx, final Product item)
	{
		return (String)item.getProperty( ctx, BookstoreCoreConstants.Attributes.Product.PRODUCTLIST);
	}
	 ...
	 * @return the productlist
	 */
	public String getProductlist(final Product item)
	{
		return getProductlist( getSession().getSessionContext(), item );
	}
	
	/**
	 * <i>Generated method</i> - Setter of the <code>Product.productlist</code> attribute. 
	 * @param value the productlist
	 */
	public void setProductlist(final SessionContext ctx, final Product item, final String value)
	{
		item.setProperty(ctx, BookstoreCoreConstants.Attributes.Product.PRODUCTLIST,value);
	}
	 ...
	 * @param value the productlist
	 */
	public void setProductlist(final Product item, final String value)
	{
		setProductlist( getSession().getSessionContext(), item, value );
	}
